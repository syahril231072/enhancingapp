...
# Variables
resourceGroup="cloud-demo-155318"
...
az aks enable-addons -a monitoring -n $clusterName -g $resourceGroup --workspace-resource-id "/subscriptions/ef7ce284-d15d-43cf-938b-46a839003eb9/resourcegroups/cloud-demo-155318/providers/microsoft.operationalinsights/workspaces/loganalytics-155318"
